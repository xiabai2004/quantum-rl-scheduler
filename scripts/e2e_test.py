...
def test_parser():
    ...
    print("\n--- [1/4] 测试任务解析器 ---")
    try:
        from src.scheduler.parser import TaskParser, Task
...
def test_env(task):
    ...
    try:
        ...
        print(f"  ✓ QuantumSchedulingEnv 接口完整")
...
def test_agent(env):
    ...
    try:
        ...
        print(f"  ✓ SchedulerAgent 接口完整")
        print(f"    - action: {action}")
        print(f"    - 动作空间: Discrete(3)")
        return agent
...
def test_annealing():
    ...
    try:
        ...
        print(f"  ✓ QuantumAnnealingOptimizer 接口完整")
...
def main():
    ...
    try:
        ...
        print(f"{'='*60}")
        print(f"测试流程:")
        print(f"  1. TaskParser → Task 对象 ✓")
        print(f"  2. QuantumSchedulingEnv → (obs, reward, done) ✓")
        print(f"  3. SchedulerAgent → action ✓")
        print(f"  4. QuantumAnnealingOptimizer → QUBO 最优解 ✓")
        print(f"{'='*60}")
        return 0
